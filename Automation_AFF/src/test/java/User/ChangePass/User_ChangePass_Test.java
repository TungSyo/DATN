...
public class User_ChangePass_Test extends Base_Test {
    ...
    public void testChangPass(String email, String oldpass, String newpass, String result, String title, String link,
        ...
        User_ChangePass_Action changepassActions = new User_ChangePass_Action(Driver_Manager.getDriver());
        ...
        try {
            ...
            for (int i = 1; i < rowCount; i++) {
                ...
                switch (action.toLowerCase()) {
                    ...
                    case "verifynotion":
                        Base_Action.handleVerification(changepassActions.verifyNotion(result), "thông báo", result);
                        break;

                    case "verifytitle":
                        Base_Action.handleVerification(changepassActions.verifyTitle(title), "tiêu đề", title);
                        break;

                    case "verifylink":
                        Base_Action.handleVerification(changepassActions.verifyLink(link), "link", link);
                        break;
                    case "close":
