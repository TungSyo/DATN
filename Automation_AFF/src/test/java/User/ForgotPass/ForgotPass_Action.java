...
public class ForgotPass_Action {
	...
	public void forgotPass(String emailforgot, String newpass, String comfirmpass) {
		clickButton(basePage.LinkForgotPassword);
		enterText(passPage.txtEmailForgot, emailforgot);
		clickButton(passPage.btnGetOTP);
		clickButton(passPage.btnToResetPass);
		enterText(passPage.txtNewPass, newpass);
		enterText(passPage.txtConfirmPass, comfirmpass);
	...
	public List<Object[]> getSearchTestData() throws IOException {
		...
		try (FileInputStream fileInputStream = new FileInputStream(file);
			...
			Sheet sheet = workbook.getSheet("Forgot_Pass");
			if (sheet == null) {
