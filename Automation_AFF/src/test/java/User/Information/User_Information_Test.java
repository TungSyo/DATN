...
public class User_Information_Test extends Base_Test {
    ...
    public void testLogin( String name, String cmnd ,String city, String district, String ward, String location, String mst, String date, String bank, String stk, String result, String title, String link, String description,
            String testType)
            throws Exception {
        ...
        User_Information_Action inforActions = new User_Information_Action(Driver_Manager.getDriver());
        ...
        try {
            ...
            for (int i = 1; i < rowCount; i++) {
                ...
                switch (action.toLowerCase()) {
                   ...
                   case "verifynotion":
                        Base_Action.handleVerification(inforActions.verifyNotion(result), "thông báo", result);
                        break;

                    case "verifytitle":
                        Base_Action.handleVerification(inforActions.verifyTitle(title), "tiêu đề", title);
                        break;

                    case "verifylink":
                        Base_Action.handleVerification(inforActions.verifyLink(link), "link", link);
                        break;
                    case "close":
