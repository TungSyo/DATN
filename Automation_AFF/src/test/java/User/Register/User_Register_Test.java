        ...
        try {
            ...
            for (int i = 1; i < rowCount; i++) {
                ...
                switch (action.toLowerCase()) {
                   ...
                   case "verifynotion":
                        Base_Action.handleVerification(registerActions.verifyNotion(result), "thông báo", result);
                        break;

                    case "verifytitle":
                        Base_Action.handleVerification(registerActions.verifyTitle(title), "tiêu đề", title);
                        break;

                    case "verifylink":
                        Base_Action.handleVerification(registerActions.verifyLink(link), "link", link);
                        break;
                    case "close":
