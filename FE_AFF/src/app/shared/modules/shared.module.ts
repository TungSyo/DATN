...
import { PaymentQrComponent } from 'src/app/components/client/shared/modules/payment-qr/payment-qr.component';
// import { OtpComponent } from 'src/app/components/client/auth/otp/otp.component';

@NgModule({
    declarations: [LoginComponent, RegisterComponent, PaymentQrComponent],
    imports: [
        CommonModule,
        FormsModule,
        ReactiveFormsModule,
